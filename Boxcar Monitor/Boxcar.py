...
class BoxcarMonitor(Notifier):
    ...
    config_meta = {'enabled': {'on_enable': [_sendEnabled]},
                   ...
                   'plugin_desc': 'Simple Boxcar.io notifier. This uses the generic Monitor Service. Enable the Monitor Service at http://boxcar.io. NOTE: this will only be available until the official XDM boxcar service is approved!'
                   }
